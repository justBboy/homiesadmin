      ...
      <div>
        ...
        >
          <div className={`sm:p-5 md:p-10`}>
            <section className="antialiased bg-gray-100 text-gray-600 flex flex-col items-center justify-center min-h-screen p-1 sm:px-4">
              <h3 className={`font-bold text-xl`}>Foods</h3>
              <Table
                hasSideAction
                hasDelete
                hasEdit
